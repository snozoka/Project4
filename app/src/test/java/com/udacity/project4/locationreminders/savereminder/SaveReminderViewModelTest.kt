...
//
//    @Test
//    fun clearOldLiveData_readysNewLiveData(){
//        //Given that a reminder =/live data objects have been saved
//
//        //When onClear() is called
//
//        //The live_data objects should all be null
//    }
//
//    @Test
//    fun validatesEnteredData_savesEnteredData() {
//        //Given the user entered data
//
//        //When validateAndSaveReminder() is called
//
//        //The ReminderDataItem is saved to the data store
//    }
//
//    @Test
